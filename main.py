...
""""
Модуль который содержит в себе функции Инициализации.
Атаки, Защиты, Специальных умений, а так же тренировок.
"""
from graphic_arts.start_game_banner import run_screensaver


def attack(char_name: str, char_class: str) -> str:
    """"Функция отвечает за генерацию урона."""
...
def defence(char_name: str, char_class: str) -> str:
    """"Функция отвечает за Блокировку урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """"Функция отвечает за Специальные уменея."""
    if char_class == 'warrior':
        return (f'{char_name}'
...
def choice_char_class() -> str:
    """"Функция отвечает за знакомство и выбор класса."""
    approve_choice: str = ''
    char_class: str = ''
